...
#SBATCH -n 1
#SBATCH -t 1-00:00:00
#SBATCH --error=maletraithet.err
#SBATCH --output=maletraithet.out
#SBATCH --job-name=produce_het_trait_SLURMM_jobs
...
/depot/fnrdewoody/apps/angsd/angsd -i pca1m_${line[0]} -ref /scratch/bell/amularo/LEPC_rerun_feb2025/LEPC_genome/ref.fa  -anc /scratch/bell/amularo/LEPC_rerun_feb2025/LEPC_genome/ref.fa  -dosaf 1 -minQ 30 -minMapQ 30 -GL 1 -P 26 -out het/pca1m_${line[0]} -doCounts 1 -setMinDepth 3 
